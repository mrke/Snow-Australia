...
snowdens<-0.15 # snow density (mg/m3)
...
rainmelt<-0.0085 # paramter in equation that melts snow with rainfall as a function of air temp, start with 0.0125
...
for(j in 1:3){
  Hotham<-c(147.145691,-36.979698)
  FallsCreek<-c(147.274,-36.868)
  Buller<-c(146.426,-37.146) 
  sitelist<-c("Falls Creek","Mount Buller","Mount Hotham")
  site<-sitelist[j]
...
if(nyears==1){
  ...
  with(plotmetout,plot(SNOWDEP~dates,type='l',ylim=c(-10,350),ylab = "",main=paste(site," ",ystart,sep="")))
  with(plotshadmet,points(SNOWDEP~dates,type='l',ylim=c(-10,350),ylab = "",col='blue',lty=2))
  
  if(site=="Mount Buller"){
    snowobs<-read.csv(file="model tests/buller.csv")
  }
  if(site=="Falls Creek"){
    snowobs<-read.csv(file="model tests/fallscreek.csv")
  }
  if(site=="Mount Hotham"){
    snowobs<-read.csv(file="model tests/hotham.csv")
  }
  ...
  points(rainfall$rainfall~rainfall$dates,type='h',col='light blue',cex=.5)
  points(snowfall$SNOWFALL~snowfall$dates,type='h',col='blue',cex=.5)
...
for(i in 1:20){
  if(i<=10){
    filename<-paste("model tests/",site,"1990_1999.pdf",sep="")
  }else{
    filename<-paste("model tests/",site,"2000_2009.pdf",sep="")
  }
  if(i==1){
    ...
    par(mfrow = c(5,2)) # set up for 5 plots in 2 columns
  ...
  plotshadsoil<-subset(shadsoil,format(shadsoil$dates, "%y")==years_snow[i])
  plotshadmet<-subset(shadmet,format(shadmet$dates, "%y")==years_snow[i])
...
# for(i in 1:20){
#   if(i<=10){
#     filename<-paste("model tests/",site,"soil1990_1999.pdf",sep="")
#   }else{
#     filename<-paste("model tests/",site,"soil2000_2009.pdf",sep="")
#   }
#   if(i==1){
#     pdf(filename,paper="A4",width=8,height=11) # doing this means you're going to make a pdf - comment this line out if you want to see them in R
#     par(mfrow = c(5,2)) # set up for 5 plots in 2 columns
...
#   #with(plotsoil,points(D100cm*10~dates,type='l',col='dark green',ylim=c(-100,350),ylab = "Snow Depth (cm)",xlab = "Year"))
#   #with(plotsoil,points(D20cm*10~dates,type='l',col='dark blue',ylim=c(-100,350),ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotsoil,plot(D0cm~dates,type='l',col='grey',ylab = "Snow Depth (cm)",xlab = "Year",ylim=c(-20,80)))
# with(plotsoil,points(D1.5cm~dates,type='l',col='1',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotsoil,points(D2.5cm~dates,type='l',col='2',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotsoil,points(D5cm~dates,type='l',col='3',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotsoil,points(D10cm~dates,type='l',col='4',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotsoil,points(D15cm~dates,type='l',col='5',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotsoil,points(D30cm~dates,type='l',col='6',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotsoil,points(D50cm~dates,type='l',col='7',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotsoil,points(D100cm~dates,type='l',col='8',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotsoil,points(D200cm~dates,type='l',col='9',ylab = "Snow Depth (cm)",xlab = "Year"))
# abline(0,0,col='light blue')
# 
#   #points(snowfall$SNOWFALL*10~snowfall$dates,type='l',col='blue',cex=.5)
#   yearplot<-1990+i-1
#   legend(min(plotmetout$dates), 75, yearplot,box.lwd = 0,box.col = "transparent",bg = "transparent")
#   if(i==10 | i==20){
#     title(main=site,outer=T)
#     dev.off()
#   }
...
# for(i in 1:20){
#   if(i<=10){
#     filename<-paste("model tests/",site,"shadsoil1990_1999.pdf",sep="")
#   }else{
#     filename<-paste("model tests/",site,"shadsoil2000_2009.pdf",sep="")
#   }
#   if(i==1){
#     pdf(filename,paper="A4",width=8,height=11) # doing this means you're going to make a pdf - comment this line out if you want to see them in R
#     par(mfrow = c(5,2)) # set up for 5 plots in 2 columns
...
#   plotshadmet<-subset(shadmet,format(shadmet$dates, "%y")==years_snow[i])
# 
# with(plotshadsoil,plot(D0cm~dates,type='l',col='grey',ylab = "Snow Depth (cm)",xlab = "Year",ylim=c(-20,80)))
# with(plotshadsoil,points(D1.5cm~dates,type='l',col='1',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotshadsoil,points(D2.5cm~dates,type='l',col='2',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotshadsoil,points(D5cm~dates,type='l',col='3',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotshadsoil,points(D10cm~dates,type='l',col='4',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotshadsoil,points(D15cm~dates,type='l',col='5',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotshadsoil,points(D30cm~dates,type='l',col='6',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotshadsoil,points(D50cm~dates,type='l',col='7',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotshadsoil,points(D100cm~dates,type='l',col='8',ylab = "Snow Depth (cm)",xlab = "Year"))
# with(plotshadsoil,points(D200cm~dates,type='l',col='9',ylab = "Snow Depth (cm)",xlab = "Year"))
# abline(0,0,col='light blue')
#   #points(snowfall$SNOWFALL*10~snowfall$dates,type='l',col='blue',cex=.5)
#   yearplot<-1990+i-1
#   legend(min(plotmetout$dates), 75, yearplot,box.lwd = 0,box.col = "transparent",bg = "transparent")
...
dummysnowdates<-as.data.frame(cbind(seq(1990,2009,1),rep(0,20)))
...
r_maxsnow<-cor(maxsnow_annual_obs$x,maxsnow_annual$x)
...
r_meansnow<-cor(meansnow_annual_obs$x,meansnow_annual$x)
...
r_snowdays<-cor(snowdays_obs$x.x,snowdays$x.x)
...
r_snowperiod<-cor(snowperiod_obs,snowperiod)
...
r_firstsnow<-cor(firstsnow_obs$x,firstsnow$x)
...
r_lastsnow<-cor(lastsnow_obs$x,lastsnow$x)
...
filename<-paste("model tests/",site,"stats2.csv",sep="")
stats_sum1<-rbind(r_maxsnow,r_meansnow,r_snowdays,r_firstsnow,r_lastsnow,r_snowperiod)
...
stats_sum_cols<-c('obs','r','rmsd','rmsdp')
...
with(plotmetout,plot(SNOWFALL~dates,type='l',col='grey',ylim=c(-10,50),ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotmetout,plot(SNOWFALL~dates,type='l',col='grey',ylim=c(0,3),ylab = "Snow Depth (cm)",xlab = "Year"))

#frost<-subset(plotmetout,FROST>0)
#points(frost$FROST~frost$dates,type='p',col='cyan',cex=.5)
#dew<-subset(plotmetout,DEW>0)
#points(dew$FROST~dew$dates,type='p',col='green',cex=.5)
#  setwd("/NicheMapR_Working/projects/snow")
# write.table(metout, file = "metout_1990_2009.csv", sep = ",", col.names = NA, qmethod = "double")
# write.table(soil, file = "soil_1990_2009.csv", sep = ",", col.names = NA, qmethod = "double")

with(plotsoil,plot(D0cm~dates,type='l',col='grey',ylab = "Snow Depth (cm)",xlab = "Year",ylim=c(-20,80)))
with(plotsoil,points(D1.5cm~dates,type='l',col='1',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(D5cm~dates,type='l',col='2',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(D10cm~dates,type='l',col='3',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(D15cm~dates,type='l',col='4',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(D20cm~dates,type='l',col='5',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(D30cm~dates,type='l',col='6',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(D50cm~dates,type='l',col='7',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(D100cm~dates,type='l',col='8',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(D200cm~dates,type='l',col='9',ylab = "Snow Depth (cm)",xlab = "Year"))
...
with(plotshadsoil,plot(D0cm~dates,type='l',col='grey',ylab = "Snow Depth (cm)",xlab = "Year",ylim=c(-20,80)))
with(plotshadsoil,points(D1.5cm~dates,type='l',col='1',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotshadsoil,points(D5cm~dates,type='l',col='2',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotshadsoil,points(D10cm~dates,type='l',col='3',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotshadsoil,points(D15cm~dates,type='l',col='4',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotshadsoil,points(D20cm~dates,type='l',col='5',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotshadsoil,points(D30cm~dates,type='l',col='6',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotshadsoil,points(D50cm~dates,type='l',col='7',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotshadsoil,points(D100cm~dates,type='l',col='8',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotshadsoil,points(D200cm~dates,type='l',col='9',ylab = "Snow Depth (cm)",xlab = "Year"))
...
with(plotmetout,plot(TS~dates,type='l',col='grey',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotmetout,points(T2~dates,type='l',col='1',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(DEP3~dates,type='l',col='2',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(DEP4~dates,type='l',col='3',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(DEP5~dates,type='l',col='4',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(DEP6~dates,type='l',col='5',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(DEP7~dates,type='l',col='6',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(DEP8~dates,type='l',col='7',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(DEP9~dates,type='l',col='8',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil,points(DEP10~dates,type='l',col='9',ylab = "Snow Depth (cm)",xlab = "Year"))
abline(0,0,col='light blue')
####################################

setwd("/NicheMapR/microclimate")
sunsnow<-read.csv('sunsnow.csv')
sunsnow<-subset(sunsnow, !duplicated(as.matrix(sunsnow[,1:2])))  
#sunsnow<-as.data.frame(cbind(dates,sunsnow))
with(sunsnow,plot(DEP9,ylim=c(-10,60),type='l',col='grey',ylab = "Snow Depth (cm)",xlab = "Year"))
with(sunsnow,points(DEP8,type='l',col='2',ylab = "Snow Depth (cm)",xlab = "Year"))
with(sunsnow,points(DEP7,type='l',col='3',ylab = "Snow Depth (cm)",xlab = "Year"))
with(sunsnow,points(DEP6,type='l',col='4',ylab = "Snow Depth (cm)",xlab = "Year"))
with(sunsnow,points(DEP5,type='l',col='5',ylab = "Snow Depth (cm)",xlab = "Year"))
with(sunsnow,points(DEP4,type='l',col='6',ylab = "Snow Depth (cm)",xlab = "Year"))
with(sunsnow,points(DEP3,type='l',col='7',ylab = "Snow Depth (cm)",xlab = "Year"))
with(sunsnow,points(DEP2,type='l',col='8',ylab = "Snow Depth (cm)",xlab = "Year"))
with(sunsnow,points(DEP1,type='l',col='9',ylab = "Snow Depth (cm)",xlab = "Year"))
abline(0,0,col='light blue')

sntherm<-as.data.frame(cbind(strtoi(format(plotmetout$dates, "%y")),plotmetout$JULDAY,plotmetout$TIME/60+1,0,plotmetout$TAREF+273,plotmetout$RH,plotmetout$VREF,plotmetout$SOLR,plotmetout$SOLR*.15, 5.670373e-8*(plotmetout$TSKYC+273)^4,plotmetout$SNOWFALL*0.75*0.4/100,2,0,0,0,0,0,0,0))
sntherm$V12[sntherm$V11==0]<-0
write.table(sntherm, file = "metswe.in", sep = " ", row.names = FALSE, qmethod = "double")

write.table(plotmetout, file = "plotmetout2.csv", sep = ",", col.names = NA, qmethod = "double")
write.table(plotsoil, file = "plotsoil2.csv", sep = ",", col.names = NA, qmethod = "double")


# test against ITEX data
load("C:/NicheMapR_Working/projects/snow/TempData2.rda")
#tzone<-paste("Etc/GMT+",10,sep="") # doing it this way ignores daylight savings!
...
plotsoil2<-subset(shadsoil,format(shadsoil$dates, "%m")=='07' & format(shadsoil$dates, "%y")=='07')
plotmetout2<-subset(shadmet,format(shadmet$dates, "%m")=='07' & format(shadmet$dates, "%y")=='07')
# remove heating treatments
TempData<-subset(TempData2,Treatment!='OTC')
site1<-subset(TempData,Site=="ITEX3B" & Plot !=700 & as.numeric(substr(TempData$Date, 7, 10)) == 2007)
site2<-subset(TempData,Site=="ITEX4B" & Plot !=700 & as.numeric(substr(TempData$Date, 7, 10)) == 2007)
site3<-subset(TempData,Site=="ITEX1U" & Plot !=700 & as.numeric(substr(TempData$Date, 7, 10)) == 2007)
site4<-subset(TempData,Site=="ITEX2U" & Plot !=700 & as.numeric(substr(TempData$Date, 7, 10)) == 2007)

#with(plotsoil,plot(DEP1~dates,type='l',col='1',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotmetout2,plot(TALOC~dates,type='l',col='1',ylab = "Soil Temp (deg C)",xlab = "Year",ylim=c(-10,60)))
#with(plotsoil2,plot(D0cm~dates,type='l',col='1',ylab = "Snow Depth (cm)",xlab = "Year"))
with(site1,points(Ambient~dtime,cex=0.1,col='red'))
with(site2,points(Ambient~dtime,cex=0.1,col='orange'))
with(site3,points(Ambient~dtime,cex=0.1,col='dark green'))
with(site3,points(Ambient~dtime,cex=0.1,col='dark blue'))

#with(plotsoil,plot(DEP1~dates,type='l',col='1',ylab = "Snow Depth (cm)",xlab = "Year"))
with(plotsoil2,plot(D0cm~dates,type='l',col='1',ylab = "Soil Temp (deg C)",xlab = "Year",ylim=c(-10,60)))
#with(plotsoil2,plot(D0cm~dates,type='l',col='1',ylab = "Snow Depth (cm)",xlab = "Year"))
with(site1,points(Surface~dtime,cex=0.1,col='red'))
with(site2,points(Surface~dtime,cex=0.1,col='orange'))
with(site3,points(Surface~dtime,cex=0.1,col='dark green'))
with(site3,points(Ambient~dtime,cex=0.1,col='dark blue'))
#with(plotsoil,plot(DEP3~dates,type='l',col='1',ylab = "Snow Depth (cm)",xlab = "Year"))

with(plotsoil2,plot(D5cm~dates,type='l',col='1',ylab = "Soil Temp (deg C)",xlab = "Year",ylim=c(-10,60)))
with(site1,points(Temp_5cm~dtime,cex=0.1,col='red'))
with(site2,points(Temp_5cm~dtime,cex=0.1,col='orange'))
with(site3,points(Temp_5cm~dtime,cex=0.1,col='dark green'))
with(site4,points(Temp_5cm~dtime,cex=0.1,col='dark blue'))

with(plotsoil2,plot(D10cm~dates,type='l',col='1',ylab = "Soil Temp (deg C)",xlab = "Year",ylim=c(-10,60)))
with(site1,points(Temp_10cm~dtime,cex=0.1,col='red'))
with(site2,points(Temp_10cm~dtime,cex=0.1,col='orange'))
with(site3,points(Temp_10cm~dtime,cex=0.1,col='dark green'))
with(site4,points(Temp_10cm~dtime,cex=0.1,col='dark blue'))
...
plot(soilmoist$dates, soilmoist[,4]*100,type='l',col = "red",lty=1,ylim = c(0,50),ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,5]*100,type='l',col = 3,lty=1,ylim = c(0,50),ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,6]*100,type='l',col = 4,lty=1,ylim = c(0,50),ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,7]*100,type='l',col = 5,lty=1,ylim = c(0,50),ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,8]*100,type='l',col = 6,lty=1,ylim = c(0,50),ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,9]*100,type='l',col = 7,lty=1,ylim = c(0,50),ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,10]*100,type='l',col = 8,lty=1,ylim = c(0,50),ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,11]*100,type='l',col = 9,lty=1,ylim = c(0,50),ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,12]*100,type='l',col = 10,lty=1,ylim = c(0,50),ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,13]*100,type='l',col = 11,lty=1,ylim = c(0,50),ylab='moisture (% vol)',xlab='date')
